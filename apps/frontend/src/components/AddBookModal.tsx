  ...
  return (
    ...
    >
      <div
        ...
        className="rounded-lg p-6 w-96 max-w-[90vw] bg-panel"
      >
        ...
        {!selected && (
          <>
            <label className="font-sans text-xs block mb-1 text-muted">
        ...
        {selected && (
          <div className="flex items-center gap-3 mb-4 p-2 rounded border border-border">
            ...
            <button
              ...
              className="font-sans text-xs text-muted underline flex-shrink-0"
            >
              Cambiar
            </button>
          </div>
